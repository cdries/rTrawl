...
ccf_trawl_p <- function(h, trawl1, trawl_par1, trawl2, trawl_par2, lag_max) {
    .Call('_rTrawl_ccf_trawl_p', PACKAGE = 'rTrawl', h, trawl1, trawl_par1, trawl2, trawl_par2, lag_max)
}
